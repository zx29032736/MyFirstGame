...
{
    public const string BUTTON_CLICK_SOUND_EFFECT = "Click_Soft_00";
    public const string BUTTON_LEAVE_SOUND_EFFECT = "Click_Soft_02";
    public const string GRASS_COMPONENT = "GrassComponent";
    public const string LIGHT_COMPONENT = "LightComponent";
    public const string DARK_COMPONENT = "DarkComponent";
    ...
    // Programatic strings
    public const string FG_TITLE_ID = "23BB";
