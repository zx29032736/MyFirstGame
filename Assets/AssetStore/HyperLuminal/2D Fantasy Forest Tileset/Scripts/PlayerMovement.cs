...
public class PlayerMovement : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		if (horizontal > 0)
		{
            GetComponent<Rigidbody2D>().velocity = new Vector2(movementSpeed * Time.deltaTime, GetComponent<Rigidbody2D>().velocity.y);//new Vector2(movementSpeed * Time.deltaTime, 0);
